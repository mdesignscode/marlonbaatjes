...
const allProjects: IAllProjects = {
  personal: {
    ...
    monty: {
      ...
      summary:
        "A bytescode interpreter using `Stack` and `Queue` data structures",
      description:
        "A command line interpreter that stores items in a list, which can either use a Stack, or a Queue data structure behind the scenes, and allows for switching between the two. The Stack and Queue are implemented using a Doubly Linked List data structure.",
